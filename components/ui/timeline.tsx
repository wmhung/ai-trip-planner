...
import { Calendar, WalletCards, Users } from 'lucide-react';
import {
  useMotionValueEvent,
  useScroll,
  useTransform,
    ...
    >
      ...
      <div ref={ref} className='relative max-w-7xl mx-auto pb-20'>
        {data.map((item, index) => (
          <div
            key={index}
            className='flex justify-start pt-10 md:pt-10 md:gap-2'
          >
            <div className='sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-[40%]'>
              ...
              <h3 className='hidden md:block text-lg md:pl-20 md:text-xl font-extrabold text-neutral-500 dark:text-neutral-500 '>
                {item.title}
              </h3>
            </div>
